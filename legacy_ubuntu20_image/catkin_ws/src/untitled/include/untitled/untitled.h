...
struct B_untitled_T {
  SL_Bus_untitled_std_msgs_UInt16MultiArray BusAssignment4;// '<S6>/Bus Assignment4' 
  SL_Bus_untitled_geometry_msgs_PoseStamped In1;// '<S20>/In1'
  SL_Bus_untitled_geometry_msgs_PoseStamped b_varargout_2;
  SL_Bus_untitled_geometry_msgs_TwistStamped In1_d;// '<S22>/In1'
  SL_Bus_untitled_geometry_msgs_TwistStamped b_varargout_2_m;
  ...
  SL_Bus_untitled_std_msgs_Bool In1_p; // '<S8>/In1'
...
struct P_untitled_T_ {
  ...
  SL_Bus_untitled_std_msgs_UInt16MultiArray Constant_Value;// Computed Parameter: Constant_Value
                                                              //  Referenced by: '<S30>/Constant'

  SL_Bus_untitled_geometry_msgs_PoseStamped Out1_Y0;// Computed Parameter: Out1_Y0
                                                       //  Referenced by: '<S20>/Out1'

  SL_Bus_untitled_geometry_msgs_PoseStamped Constant_Value_p;// Computed Parameter: Constant_Value_p
                                                                //  Referenced by: '<S10>/Constant'

  SL_Bus_untitled_geometry_msgs_TwistStamped Out1_Y0_e;// Computed Parameter: Out1_Y0_e
                                                          //  Referenced by: '<S22>/Out1'

  SL_Bus_untitled_geometry_msgs_TwistStamped Constant_Value_e;// Computed Parameter: Constant_Value_e
                                                                 //  Referenced by: '<S21>/Constant'

  SL_Bus_untitled_std_msgs_Bool Out1_Y0_k;// Computed Parameter: Out1_Y0_k
                                             //  Referenced by: '<S8>/Out1'

  SL_Bus_untitled_std_msgs_Bool Constant_Value_m;// Computed Parameter: Constant_Value_m
...
//
//  '<Root>' : 'untitled'
//  '<S1>'   : 'untitled/Convert to PWM'
//  '<S2>'   : 'untitled/Get Autonomy Mode'
//  '<S3>'   : 'untitled/Get Mocap Pose'
//  '<S4>'   : 'untitled/Get Mocap Velocity'
//  '<S5>'   : 'untitled/Position Control'
//  '<S6>'   : 'untitled/Publish to Pi'
//  '<S7>'   : 'untitled/Get Autonomy Mode/Subscribe'
//  '<S8>'   : 'untitled/Get Autonomy Mode/Subscribe/Enabled Subsystem'
//  '<S9>'   : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1'
//  '<S10>'  : 'untitled/Get Mocap Pose/Subscribe'
//  '<S11>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles'
//  '<S12>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation'
//  '<S13>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize'
//  '<S14>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input'
//  '<S15>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem'
//  '<S16>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem1'
//  '<S17>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem2'
//  '<S18>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus'
//  '<S19>'  : 'untitled/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S20>'  : 'untitled/Get Mocap Pose/Subscribe/Enabled Subsystem'
//  '<S21>'  : 'untitled/Get Mocap Velocity/Subscribe'
//  '<S22>'  : 'untitled/Get Mocap Velocity/Subscribe/Enabled Subsystem'
//  '<S23>'  : 'untitled/Position Control/MATLAB Function'
//  '<S24>'  : 'untitled/Position Control/MATLAB Function1'
//  '<S25>'  : 'untitled/Position Control/PID X_E'
//  '<S26>'  : 'untitled/Position Control/PID Y_E'
//  '<S27>'  : 'untitled/Position Control/PID Z_E'
//  '<S28>'  : 'untitled/Position Control/Validity Verifier'
//  '<S29>'  : 'untitled/Position Control/Validity Verifier/MATLAB Function'
//  '<S30>'  : 'untitled/Publish to Pi/Blank Message4'
//  '<S31>'  : 'untitled/Publish to Pi/Publish'
