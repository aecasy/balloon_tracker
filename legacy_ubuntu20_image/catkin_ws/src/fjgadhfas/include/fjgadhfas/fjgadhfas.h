...
//
#ifndef RTW_HEADER_fjgadhfas_h_
#define RTW_HEADER_fjgadhfas_h_
#include "rtwtypes.h"
...
struct B_fjgadhfas_T {
  SL_Bus_fjgadhfas_std_msgs_UInt16MultiArray BusAssignment4;// '<S6>/Bus Assignment4' 
  SL_Bus_fjgadhfas_geometry_msgs_PoseStamped In1;// '<S20>/In1'
  SL_Bus_fjgadhfas_geometry_msgs_PoseStamped b_varargout_2;
  SL_Bus_fjgadhfas_geometry_msgs_TwistStamped In1_d;// '<S22>/In1'
  SL_Bus_fjgadhfas_geometry_msgs_TwistStamped b_varargout_2_m;
  ...
  SL_Bus_fjgadhfas_std_msgs_Bool In1_p;// '<S8>/In1'
...
struct P_fjgadhfas_T_ {
  ...
  SL_Bus_fjgadhfas_std_msgs_UInt16MultiArray Constant_Value;// Computed Parameter: Constant_Value
                                                               //  Referenced by: '<S30>/Constant'

  SL_Bus_fjgadhfas_geometry_msgs_PoseStamped Out1_Y0;// Computed Parameter: Out1_Y0
                                                        //  Referenced by: '<S20>/Out1'

  SL_Bus_fjgadhfas_geometry_msgs_PoseStamped Constant_Value_p;// Computed Parameter: Constant_Value_p
                                                                 //  Referenced by: '<S10>/Constant'

  SL_Bus_fjgadhfas_geometry_msgs_TwistStamped Out1_Y0_e;// Computed Parameter: Out1_Y0_e
                                                           //  Referenced by: '<S22>/Out1'

  SL_Bus_fjgadhfas_geometry_msgs_TwistStamped Constant_Value_e;// Computed Parameter: Constant_Value_e
                                                                  //  Referenced by: '<S21>/Constant'

  SL_Bus_fjgadhfas_std_msgs_Bool Out1_Y0_k;// Computed Parameter: Out1_Y0_k
                                              //  Referenced by: '<S8>/Out1'

  SL_Bus_fjgadhfas_std_msgs_Bool Constant_Value_m;// Computed Parameter: Constant_Value_m
...
extern "C"
{
  ...
  extern P_fjgadhfas_T fjgadhfas_P;
...
extern "C"
{
  ...
  extern struct B_fjgadhfas_T fjgadhfas_B;
...
extern struct DW_fjgadhfas_T fjgadhfas_DW;
...
extern "C"
{
  ...
  extern void fjgadhfas_initialize(void);
  extern void fjgadhfas_step(void);
  extern void fjgadhfas_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_fjgadhfas_T *const fjgadhfas_M;
...
//
//  '<Root>' : 'fjgadhfas'
//  '<S1>'   : 'fjgadhfas/Convert to PWM'
//  '<S2>'   : 'fjgadhfas/Get Autonomy Mode'
//  '<S3>'   : 'fjgadhfas/Get Mocap Pose'
//  '<S4>'   : 'fjgadhfas/Get Mocap Velocity'
//  '<S5>'   : 'fjgadhfas/Position Control'
//  '<S6>'   : 'fjgadhfas/Publish to Pi'
//  '<S7>'   : 'fjgadhfas/Get Autonomy Mode/Subscribe'
//  '<S8>'   : 'fjgadhfas/Get Autonomy Mode/Subscribe/Enabled Subsystem'
//  '<S9>'   : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1'
//  '<S10>'  : 'fjgadhfas/Get Mocap Pose/Subscribe'
//  '<S11>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles'
//  '<S12>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation'
//  '<S13>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize'
//  '<S14>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input'
//  '<S15>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem'
//  '<S16>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem1'
//  '<S17>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Angle Calculation/Protect asincos input/If Action Subsystem2'
//  '<S18>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus'
//  '<S19>'  : 'fjgadhfas/Get Mocap Pose/Quaternion to Euler (ROS)1/Quaternions to Rotation Angles/Quaternion Normalize/Quaternion Modulus/Quaternion Norm'
//  '<S20>'  : 'fjgadhfas/Get Mocap Pose/Subscribe/Enabled Subsystem'
//  '<S21>'  : 'fjgadhfas/Get Mocap Velocity/Subscribe'
//  '<S22>'  : 'fjgadhfas/Get Mocap Velocity/Subscribe/Enabled Subsystem'
//  '<S23>'  : 'fjgadhfas/Position Control/MATLAB Function'
//  '<S24>'  : 'fjgadhfas/Position Control/MATLAB Function1'
//  '<S25>'  : 'fjgadhfas/Position Control/PID X_E'
//  '<S26>'  : 'fjgadhfas/Position Control/PID Y_E'
//  '<S27>'  : 'fjgadhfas/Position Control/PID Z_E'
//  '<S28>'  : 'fjgadhfas/Position Control/Validity Verifier'
//  '<S29>'  : 'fjgadhfas/Position Control/Validity Verifier/MATLAB Function'
//  '<S30>'  : 'fjgadhfas/Publish to Pi/Blank Message4'
//  '<S31>'  : 'fjgadhfas/Publish to Pi/Publish'

#endif                                 // RTW_HEADER_fjgadhfas_h_
