...
def app_config_from_dict(data: Dict[str, Any]) -> AppConfig:
    ...
    return AppConfig(
        ...
        scoring=ScoringConfig(
            ...
            color_fill_enabled=bool(scoring_data.get("color_fill_enabled", True)),
            color_fill_weight=float(scoring_data.get("color_fill_weight", 0.25)),
            circularity_enabled=bool(scoring_data.get("circularity_enabled", True)),
            circularity_weight=float(scoring_data.get("circularity_weight", 0.05)),
            circle_fit_enabled=bool(scoring_data.get("circle_fit_enabled", True)),
            circle_fit_weight=float(scoring_data.get("circle_fit_weight", 0.25)),
            enclosing_fill_enabled=bool(scoring_data.get("enclosing_fill_enabled", True)),
            enclosing_fill_weight=float(scoring_data.get("enclosing_fill_weight", 0.15)),
            solidity_enabled=bool(scoring_data.get("solidity_enabled", True)),
            solidity_weight=float(scoring_data.get("solidity_weight", 0.10)),
            relative_area_enabled=bool(scoring_data.get("relative_area_enabled", True)),
            relative_area_weight=float(scoring_data.get("relative_area_weight", 0.20)),
...
def with_overrides(config: AppConfig, **overrides: Any) -> AppConfig:
    ...
    scoring = ScoringConfig(
        ...
        color_fill_enabled=_value_or(config.scoring.color_fill_enabled, overrides.get("color_fill_enabled")),
        color_fill_weight=_value_or(config.scoring.color_fill_weight, overrides.get("color_fill_weight")),
        circularity_enabled=_value_or(config.scoring.circularity_enabled, overrides.get("circularity_enabled")),
        circularity_weight=_value_or(config.scoring.circularity_weight, overrides.get("circularity_weight")),
        circle_fit_enabled=_value_or(config.scoring.circle_fit_enabled, overrides.get("circle_fit_enabled")),
        circle_fit_weight=_value_or(config.scoring.circle_fit_weight, overrides.get("circle_fit_weight")),
        enclosing_fill_enabled=_value_or(config.scoring.enclosing_fill_enabled, overrides.get("enclosing_fill_enabled")),
        enclosing_fill_weight=_value_or(config.scoring.enclosing_fill_weight, overrides.get("enclosing_fill_weight")),
        solidity_enabled=_value_or(config.scoring.solidity_enabled, overrides.get("solidity_enabled")),
        solidity_weight=_value_or(config.scoring.solidity_weight, overrides.get("solidity_weight")),
        relative_area_enabled=_value_or(config.scoring.relative_area_enabled, overrides.get("relative_area_enabled")),
        relative_area_weight=_value_or(config.scoring.relative_area_weight, overrides.get("relative_area_weight")),
